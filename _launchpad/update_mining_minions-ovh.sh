...
ANSIBLE_PLAYBOOKS_DIR=$ANSIBLE_CONF_DIR/playbooks/update_minion_package
...
chmod u+x $LAUNCHPAD_DIR/update_mining_minions-ovh.sh
...
ansible-playbook $ANSIBLE_PLAYBOOKS_DIR/aptupgrade_mining-minions-ovh.yml
exit
